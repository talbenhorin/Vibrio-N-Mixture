...
vibrio <- list(c=dat$vvha,v=dat$mass,samp=dat$fid,site=dat$site,temp=dat$temp,water=dat$water,watervib=dat$water.vvha) #data string, total vibrio
...
base.inits <- list(list("U"=numeric(3),"V"=numeric(48),"tau_U"=0.1,"tau_V"=0.1,"b0"=1),
